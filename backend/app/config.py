...
class Settings(BaseSettings):
    ...
    ai_reconciliation_pending_seconds: int = Field(default=300, ge=30, le=86_400)
    ai_reconciliation_dispatched_seconds: int = Field(default=600, ge=30, le=86_400)
    ai_reconciliation_running_seconds: int = Field(default=1_800, ge=60, le=86_400)
    ai_reconciliation_lease_seconds: int = Field(default=120, ge=30, le=3_600)
    ...
    pilot_browser_fallback_rate: float = Field(default=0.20, ge=0, le=1)
    pilot_ai_fallback_rate: float = Field(default=0.05, ge=0, le=1)
